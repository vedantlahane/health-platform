<x-app-layout>
    <x-slot name="header">
        <h1 class="text-3xl font-extrabold text-blue-800 mb-2">Edit Doctor</h1>
        <p class="text-gray-600">Update doctor details and profile information.</p>
    </x-slot>
    ...
    <form action="{{ route('doctors.update', $doctor) }}" method="POST" class="bg-white p-10 rounded-2xl shadow-xl mb-10">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
                ...
                <select name="is_available" class="border p-2 w-full rounded">
                    <option value="1" @selected(old('is_available', $doctor->is_available) == 1)>Yes</option>
                    <option value="0" @selected(old('is_available', $doctor->is_available) == 0)>No</option>
                </select>
            </div>
            <div>
